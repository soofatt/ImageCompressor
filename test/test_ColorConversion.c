...
void test_convertToChrombaB_given_rgb_should_obtain_Cb(void){
	short int red[8][8] = {{48, 176, 191, 112, 212, 194, 24, 173},
                         {123, 233, 148, 224, 196, 12, 147, 8},
                         {21, 7, 41, 112, 213, 31, 183, 5},
                         {170, 234, 83, 229, 42, 226, 107, 242},
  ...
  convertToChromaB(red, green, blue, Cb);
  
  TEST_ASSERT_EQUAL(146, Cb[0][0]);
  TEST_ASSERT_EQUAL(80, Cb[0][1]);
}

void test_convertToChrombaR_given_rgb_should_obtain_Cb(void){
	short int red[8][8] = {{48, 176, 191, 112, 212, 194, 24, 173},
                         {123, 233, 148, 224, 196, 12, 147, 8},
                         {21, 7, 41, 112, 213, 31, 183, 5},
                         {170, 234, 83, 229, 42, 226, 107, 242},
  ...
  convertToChromaR(red, green, blue, Cr);
